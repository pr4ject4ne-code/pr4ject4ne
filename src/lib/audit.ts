...
export type AuditAction =
  ...
  | 'general_rating_submitted'
  | 'rating_dispute_filed'
  | 'rating_dispute_resolved'
  | 'association_ranking_issued'
  | 'association_ranking_cleared'
